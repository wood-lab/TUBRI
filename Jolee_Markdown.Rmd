...
#### Import dataset 
- make sure you name all these new datasets and frames sometheing different from what you named them above (that way we can still run all the analyses in total without losing any of the previous ones)
```{r full dataset import, echo=TRUE}

```

### Split everything into adult or larval based on the designations from initial analyses. Remove all non-concern cases of parasites (leech, nematomorph)

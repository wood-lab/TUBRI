...
ggplot(mydf, aes(x = x, y = predicted, color = group)) + 
  geom_jitter(width = 0.4, height = 0, alpha = 0.6) +  # Increase width of jitter for more points
  geom_point(alpha = 0.6, size = 2) +  # Increase point size and adjust alpha for better visibility
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.1, alpha = 0.5) +  # Reduce error bar width and transparency
  scale_color_manual(values = c("#969696", "#ce1256", "blue")) +

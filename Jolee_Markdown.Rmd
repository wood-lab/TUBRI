...
#### Plots -- need to fix the called items
```{r q1 plots}
...
plot(mydf, rawdata = TRUE, alpha = 0.3, dot.alpha = 0.6,colors=c("#969696","#ce1256"))+
  ...
  apatheme +
  scale_y_continuous(limits = c(0, NA)) + geom_jitter()
...
### Plot life stage data using original dataframe (with above-mentioned exclusions and without) (to answer question 2)

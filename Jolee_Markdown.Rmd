...
body.index.vig <- ((Pvig.life.stage$weight_mg/((Pvig.life.stage$standard_length_mm)^3)))*(100)
body.index.ath <- ((Nath.life.stage$weight_mg/((Nath.life.stage$standard_length_mm)^3)))*(100)
body.index.pun <- ((Ipun.life.stage$weight_mg/((Ipun.life.stage$standard_length_mm)^3)))*(100)
```
...
NA.bc.fcf <- ggplot(Nath.life.stage, # plot doesn't show the two different plots, just the same one twice
       aes(x = as.factor(BinaryCode), y = body.index.ath)) + xlab("Life Stage")  + geom_boxplot() +

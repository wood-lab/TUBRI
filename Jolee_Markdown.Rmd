...
full.data.stages <- full.data %>%
  mutate(
    ...
    psite_taxon = case_when(
      ...
      startsWith(psite_spp_x, "META") ~ "meta",
...
summary(q3m <- lmer(fcf ~ relevel(life_stage, ref = "uninfected") + relevel(life_stage, ref = "uninfected"):relevel(psite_taxon, ref = "uninfected")+ (1|catalog_number), data = full.data.stages))
